...
import pandas as pd
Test_trans = pd.read_csv('../input/transaction_round1_new.csv')

Test_tag = pd.read_csv('../input/sample_new.csv')  # 测试样本
...
pred_data_rule[['UID', 'Tag']].to_csv('pred_data_rule_1206.csv', index=False)
